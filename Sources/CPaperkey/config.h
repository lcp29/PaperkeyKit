...
/* Build host OS */
#define HOST_OS "darwin25.0.0"

/* Name of package */
#define PACKAGE "paperkey"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "dshaw@jabberwocky.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "paperkey"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "paperkey 1.6"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "paperkey"
